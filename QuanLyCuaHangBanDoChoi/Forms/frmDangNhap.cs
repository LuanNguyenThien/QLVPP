...
namespace QuanLyCuaHangBanDoChoi.Forms
{
    public partial class frmDangNhap : Form
    {
        ...
        private void XuLyDangNhap()
        {
            ...
            Global.username = txtTenDangNhap.Text;
            Global.password = txtMatKhau.Text;
            if (TaiKhoanBL.GetInstance.CheckLogin(txtTenDangNhap.Text, txtMatKhau.Text))
            {
                btnDangNhap.BackColor = Color.FromArgb(0, 100, 0);
                TenNhanVien = NhanVienBL.GetInstance.GetTenNhanVien(txtTenDangNhap.Text.ToString().Trim());
                TenDangNhap = txtTenDangNhap.Text.ToString().Trim();
                MaNV = NhanVienBL.GetInstance.GetMaNhanVien(txtTenDangNhap.Text.ToString().Trim());
                Quyen = TaiKhoanBL.GetInstance.GetTenQuyen(txtTenDangNhap.Text.ToString().Trim());
