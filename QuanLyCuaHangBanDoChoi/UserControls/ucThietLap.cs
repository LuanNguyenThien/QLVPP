...
namespace QuanLyCuaHangBanDoChoi.UserControls
{
    public partial class ucThietLap : UserControl
    {
        ...
        private void btnXacNhan_Click(object sender, EventArgs e)
        {
            if (b)
            {
                if (TaiKhoanBL.GetInstance.CheckLogin(frmDangNhap.TenDangNhap, txtMatKhauHienTai.Text))
                {
                    if(TaiKhoanBL.GetInstance.DoiMatKhau(frmDangNhap.TenDangNhap, txtMatKhauMoi.Text))
                    {
